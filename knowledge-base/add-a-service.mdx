...
<Tip>
  ...
  version](https://github.com/coollabsio/coolify/blob/main/templates/service-templates.json). More info can be found in under [Generating Service Template](#generating-service-template).
</Tip>

### Generating Service Template
When adding a new Service you wish to find it in the list to verify the [Metadata](#metadata) or just installing it quickly.
